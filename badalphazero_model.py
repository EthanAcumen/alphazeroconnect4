...
# helper: save & load
def save_alphazero_model(net: AlphaZeroNet, filename="badalphazero_connect4.pth"):
    torch.save(net.state_dict(), filename)
    print(f"AlphaZero model saved to {filename}")

def load_alphazero_model(net: AlphaZeroNet, filename="badalphazero_connect4.pth"):
...
def main():
    ...
    if mode == 12:
        ...
        load_alphazero_model(net, "badalphazero_connect4.pth")  # Load trained model if exists
    ...
    if mode == 13:
        ...
        env = Connect4Env()
        net = AlphaZeroNet(rows=ROW_COUNT, cols=COLUMN_COUNT, hidden_size=128)
        load_alphazero_model(net, "badalphazero_connect4.pth")  # Load existing model (if any)
        ...
        save_alphazero_model(net, "badalphazero_connect4.pth")
